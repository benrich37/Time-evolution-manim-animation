...
# from ... import methods, classes, ref
...
class Intro(Scene):
    def construct(self):
        ...
        electron = ImageMobject(imgs_path + "electron.png").scale(1/3).shift(RIGHT*3).shift(UP*2)
        spring = ImageMobject(imgs_path + "spring.png").scale(1 / 3).shift(RIGHT * 3).shift(DOWN * 2)
        self.add(psi_pure)
